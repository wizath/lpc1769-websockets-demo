...
PINSEL_CFG_Type xPinConfig;
	...
	/* set MAC hardware address length. MAC address already set  */
	...
	Emac_Config.Mode =EMAC_MODE_AUTO /*EMAC_MODE_100M_FULL*/;
...
#if 0
/*
 * Includes CodeRed macro for __BSS(RAM2) i.e. AHB RAM
 */
